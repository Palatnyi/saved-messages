...
import { handleNewMessage, handleReply, handleVoiceMessage, handleDeleteReminder } from "./handlers/message";
...
export function setupBot(): void {
  ...
  bot.callbackQuery(/^del_rem:/, handleDeleteReminder);
  bot.callbackQuery("noop", (ctx) => ctx.answerCallbackQuery());
  bot.callbackQuery("cancel_tz", (ctx) => ctx.answerCallbackQuery());
